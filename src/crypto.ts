...
export function convertRSASSAPSSToEnc(keyRSAPSSEncSpki: Uint8Array): Uint8Array {
  ...
  const schema = new asn1js.Sequence({
    value: [new asn1js.Sequence({ name: 'algorithm' }), new asn1js.BitString({ name: 'subjectPublicKey' })],
  });
  ...
  const keyASN = new asn1js.Sequence({
    value: [
      new asn1js.Sequence({
        value: [new asn1js.ObjectIdentifier({ value: RSAEncryptionAlgID }), new asn1js.Null()],
      }),
